...
def collect_all_data_files():
    ...
    data_files_dict = {
        ...
        "il_jobs_2017": collect_il_jobs_2017_data(),
        "il_geo_xwalk": collect_il_geo_xwalk_data(),
...
def collect_pums_2017_data():
    """
    Download the 2017 5-year ACS PUMS person-level records for the state of IL
    """
    PUMS_2017_URL = "https://www2.census.gov/programs-surveys/acs/data/pums/2017/5-Year/csv_pil.zip"
    PUMS_2017_CSV_NAME = "psam_p17.csv"
...
def collect_il_jobs_2017_data():
    """
    Download the 2017 IL jobs data
    """
    IL_JOBS_2017_URL = "https://lehd.ces.census.gov/data/lodes/LODES7/il/wac/il_wac_S000_JT00_2017.csv.gz"
    return collect_gzip_data(IL_JOBS_2017_URL)


def collect_il_geo_xwalk_data():
    """
    Download the IL geographic crosswalk data
    """
    IL_GEO_XWALK_URL = "https://lehd.ces.census.gov/data/lodes/LODES7/il/il_xwalk.csv.gz"
    return collect_gzip_data(IL_GEO_XWALK_URL)
